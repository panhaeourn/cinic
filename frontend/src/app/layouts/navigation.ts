...
const navigationOrderByRole: Record<ClinicRole, string[]> = {
  ...
  RECEPTIONIST_CASHIER: ['Dashboard', 'Patients', 'Appointments', 'Queue', 'Billing', 'Payments', 'Certificates', 'Reports'],
...
export const routeRoles = {
  ...
  certificates: ['ADMIN', 'RECEPTIONIST_CASHIER'],
...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: Award,
    allowedRoles: routeRoles.certificates,
    status: 'ready',
  },
  {
    label: 'Reports',
